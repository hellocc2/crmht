<?php /* Smarty version 2.6.18, created on 2019-07-10 18:01:36
         compiled from admin_index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_siderbar', 'admin_index.html', 249, false),)), $this); ?>
...
admin/add.html"><img src="<?php echo $this->_tpl_vars['media']; ?>
/css/icons/32/group_add.png">添加管理员</a>
                </div>
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-table-1 ">用户管理</span>
                    </div>
                        ...
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                <tr class="gradeX">
									...
									<td class="center">
									<a href="<?php echo $this->_tpl_vars['root_url']; ?>
admin/edit.html"><img src="<?php echo $this->_tpl_vars['media']; ?>
/css/icons/16/edit.png">编辑</a>
									<a href="<?php echo $this->_tpl_vars['root_url']; ?>
admin/del.html"><img src="<?php echo $this->_tpl_vars['media']; ?>
/css/icons/16/cross.png">删除</a>
									</td>
                                </tr>
                                <tr class="gradeC">
                                    <td>Trident</td>
...
/css/icons/16/edit.png">编辑</a>
									<a href="<?php echo $this->_tpl_vars['root_url']; ?>
admin/del.html"><img src="<?php echo $this->_tpl_vars['media']; ?>
/css/icons/16/cross.png">删除</a></td>
                                </tr>
                                <tr class="gradeA">
                                    <td>Trident</td>
                                    <td>Internet
...
/css/icons/16/cross.png">删除</a></td>
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td class="center">A</td>
									<td class="center"><a href="<?php echo $this->_tpl_vars['root_url']; ?>
admin/edit.html"><img src="<?php echo $this->_tpl_vars['media']; ?>
/css/icons/16/edit.png">编辑</a>
									<a href="<?php echo $this->_tpl_vars['root_url']; ?>
admin/del.html"><img src="<?php echo $this->_tpl_vars['media']; ?>
